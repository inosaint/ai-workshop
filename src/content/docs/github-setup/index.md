...
Download [Github Desktop](https://desktop.github.com) and login with your newly created credentials.

### Step 3:

[Create a new repository](https://docs.github.com/en/desktop/overview/creating-your-first-repository-using-github-desktop#creating-a-new-repository)(repo) using Github Desktop. Name it using the following format: [username].github.io, where *username* is your github username. This is what will be used as your free github domain. Please do not make mistakes, the name of the repository should be identical in spelling and case to your github username.
...
While publishing, please remember to uncheck 'Keep this code private' checkbox.
