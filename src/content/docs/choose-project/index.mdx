...
1. Follow one of our three guided projects
2. Create your own unique project
...
<div class="prompt-editor" style="margin: 2rem 0; padding: 2rem; background: var(--sl-color-gray-1); border-radius: 12px;">
  ...
  <div style="display: grid; gap: 1rem; margin-bottom: 1.5rem;">
    <div>
      ...
      <select id="projectType" style="width: 100%; padding: 0.75rem; border: 1px solid var(--sl-color-gray-3); border-radius: 8px; font-size: 1rem;">
    ...
    <div>
      ...
      <textarea id="projectIdea" placeholder="e.g., A recipe organizer where I can save and search my favorite recipes" style="width: 100%; padding: 0.75rem; border: 1px solid var(--sl-color-gray-3); border-radius: 8px; font-size: 1rem; min-height: 80px; resize: vertical;"></textarea>
    </div>

    <div>
      <label style="display: block; font-weight: 500; margin-bottom: 0.5rem;">Key features (comma-separated)</label>
      <input type="text" id="projectFeatures" placeholder="e.g., search, favorites, categories, dark mode" style="width: 100%; padding: 0.75rem; border: 1px solid var(--sl-color-gray-3); border-radius: 8px; font-size: 1rem;" />
    </div>

    <div>
      <label style="display: block; font-weight: 500; margin-bottom: 0.5rem;">Color preference (optional)</label>
      <input type="text" id="projectColors" placeholder="e.g., blue and white, dark theme, colorful" style="width: 100%; padding: 0.75rem; border: 1px solid var(--sl-color-gray-3); border-radius: 8px; font-size: 1rem;" />
    </div>
  </div>
...
<div style="display: flex; justify-content: space-between; margin-top: 2rem;">
  <a href="/ai-workshop/git-basics/" style="padding: 0.75rem 1.5rem; border: 2px solid var(--sl-color-gray-3); color: inherit; text-decoration: none; border-radius: 8px;">
    ← Git Basics
  </a>
  <a href="/ai-workshop/building-with-claude/" style="padding: 0.75rem 1.5rem; background: var(--sl-color-accent); color: white; text-decoration: none; border-radius: 8px; font-weight: 600;">
