...
<div class="prompt-editor" style="margin: 2rem 0; padding: 2rem; background: var(--sl-color-gray-1); border-radius: 12px;" role="region" aria-labelledby="prompt-builder-heading">
  ...
  <div style="display: grid; gap: 1rem; margin-bottom: 1.5rem;">
    ...
    <div class="prompt-field">
      ...
      />
      <span id="projectFeaturesHelp" style="font-size: 0.875rem; color: var(--sl-color-gray-5); margin-top: 0.25rem; display: block;">Separate features with commas</span>
    </div>
